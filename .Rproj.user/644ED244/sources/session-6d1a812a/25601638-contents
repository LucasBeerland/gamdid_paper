...
ggarrange(plot_gamdid_DE_petro, plot_gamdid_DV_petro, plot_gamdid_DB_petro, plot_gamdid_DM_petro, plot_gamdid_DP_petro,
          common.legend = T, ncol = 1, legend = "top", heights = c(1,1,1,1,1.3)) -> fig9

ggsave(filename = here::here("figures", "output", "jpg", "fig9.jpg"), plot = fig9,
       width = FIG_WIDTH, height = FIG_HEIGHT_TRIPLE,
       dpi = FIG_DPI)
ggsave(filename = here::here("figures", "output", "pdf", "fig9.pdf"), plot = fig9,
       width = FIG_WIDTH, height = FIG_HEIGHT_TRIPLE)

...
ggarrange(ex_caseStudy_mock, ex_caseStudy, plot_spikein,
          ncol = 1, common.legend = T,  heights = c(1, 1, 0.25), align = "v") -> figS9

ggsave(filename = here::here("figures", "output", "jpg", "figS9.jpg"), plot = figS9,
       width = FIG_WIDTH, height = FIG_HEIGHT_DOUBLE,
       dpi = FIG_DPI)
ggsave(filename = here::here("figures", "output", "pdf", "figS9.pdf"), plot = figS9,
       width = FIG_WIDTH, height = FIG_HEIGHT_DOUBLE)

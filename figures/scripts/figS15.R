...
ggarrange(ex_caseStudy_mock, ex_caseStudy, plot_spikein,
          ncol = 1, common.legend = T,  heights = c(1, 1, 0.25), align = "v") -> figS15

ggsave(filename = here::here("figures", "output", "jpg", "figS15.jpg"), plot = figS15,
       width = FIG_WIDTH, height = FIG_HEIGHT_DOUBLE,
       dpi = FIG_DPI)
ggsave(filename = here::here("figures", "output", "pdf", "figS15.pdf"), plot = figS15,
       width = FIG_WIDTH, height = FIG_HEIGHT_DOUBLE)
